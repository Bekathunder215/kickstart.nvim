...
-- Always keep regex syntax/filetype fallback enabled.
-- Treesitter can coexist with this and it prevents plain text buffers when
-- parsers are missing or fail to install.
...
require('lazy').setup({
  ...
  -- Telescope and LSP are modularized in lua/custom/plugins/*.lua.
  ...
  -- Treesitter is modularized in lua/custom/plugins/treesitter.lua.
